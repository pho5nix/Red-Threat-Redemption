...
## Zeek & Suricata Log ingestion - Filebeat
...
Copy and rename file suricata.yml.disabled
```
sudo cp /etc/filebeat/modules.d/suricata.yml.disabled /etc/filebeat/modules.d/suricata.yml
```
Edit suricata.yml - Enable logs according to your requirements
```
sudo vim /etc/filebeat/modules.d/suricata.yml

# Module: suricata
# Docs: https://www.elastic.co/guide/en/beats/filebeat/current/filebeat-module-suricata.html
...
```
### Setup Suricata pipilines from filebeat
```
